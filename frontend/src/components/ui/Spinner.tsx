...
export function FullPageSpinner({ label }: { label?: string }) {
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center gap-3 bg-gradient-to-br from-violet-50 via-white to-fuchsia-50 dark:from-[#0b0a10] dark:via-[#100e18] dark:to-[#0b0a10]">
      <Spinner size={40} />
